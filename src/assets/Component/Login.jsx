...
export default function LoginFinal() {
  ...
  const handleLogin = () => {
    ...
    if (email === 'johndoe@email.com' && password === 'password') {
      localStorage.setItem('authToken', 'your_auth_token');
      history('/protected'); // Redirect to the protected route
    } else {
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ marginTop: '20px' }}>
                  <Typography fontSize="sm" sx={{ alignSelf: 'center' }} fontWeight={500}>
                    Not joined us yet?<br />
                    <Link onClick={toggleForm} style={{ marginRight: 20, cursor: 'pointer', color: 'rgb(214,107,64)' }}>Signup here</Link>
                  </Typography>
                </div>
              </div>
              <div>
                <div style={{ marginTop: 6 }}>
                  ...
                  <Typography  fontWeight={500} sx={{ alignItems: 'center', textAlign: 'center', marginLeft: 17, color: 'black' }} >
                    OR
                  </Typography>
                </div>
...
const styles ={
  ...
  siteName: { color: 'black', fontSize: 30, fontWeight: 'bold', marginTop: -20 },
